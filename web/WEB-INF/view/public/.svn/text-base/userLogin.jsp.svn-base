<%-- 
    Document   : userLogin
    Created on : 25-abr-2011, 21:07:35
...
<html>
	...
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Escriba sus datos para loguearse</b></p>
                        <br /><p></p>
                ...
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Si no recuerda su password, escriba su usuario y lo enviamos por correo:</b></p>
                        <br /><p></p>
                        <form method="post" action="/TiendaOnline/go">
                            <input name="to" value="mailuser" type="hidden"><pre>
                            <p class="line"><span>Usuario:  </span> <input name="nick" value="" type="text" /></p></pre>
                            <p class="line center pad20"><button>Recordar</button>
                        </form>
                        </div>
                 </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>O bien pruebe a<a href="/TiendaOnline/go?to=register" class="reg">registrarse</a></b></p>
                    </div>
                 </div>
            </div>
