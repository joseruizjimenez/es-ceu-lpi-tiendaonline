<%-- 
    ...
    Created on : 25-abr-2011, 21:15:43
                ...
                <div id="content">
                    <div id="about">
                        ...
                        <form method="post" action="/TiendaOnline/go">
                            <input name="to" value="search" type="hidden"><pre>

                            <p class="line"><span>Disco:         </span><input name="name" value="" type="text" /></p>
                            <p class="line"><span>Artista:      </span> <input name="artist" value="" type="text" /></p>
                            <p class="line"><span>Discografica: </span> <input name="recordLabel" value="" type="text" /></p>
                            <p class="line"><span>Estilo:       </span> <input name="type" value="" type="text" /></p>
                            </pre>
                        ...
                        <%if(list!=null && !list.isEmpty()) { 
                           ...
                           for(Object obj : list) { 
                            ...
                            <div class="description">																																																																																																																																																			<div class="inner_copy"><a href="http://www.bestfreetemplates.org/">free templates</a><a href="http://www.bannermoz.com/">banner templates</a></div>
                                ...
                                <a href="/TiendaOnline/go?to=shoppingcart&id=<%=record.getIdAsString()%>&n=1"><img src="cssimages/carts.gif" alt="" width="16" height="24" /></a>
