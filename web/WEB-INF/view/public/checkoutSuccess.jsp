<%-- 
    ...
    Created on : 25-abr-2011, 21:08:57
...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="emailBill" scope="session" class="java.lang.String" />
	...
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Su compra se ha efectuado con exito!</b></p>
                        <br /><p></p>
                        <p class="line"><span><pre><%=emailBill%></pre></span></p>                        
                    </div>
                </div>
                <% if(authenticated != null && authenticated.equals("true")) { %>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Pulse el boton y le enviamos la factura por correo:</b></p>
                        <br /><p></p>
                        <form method="post" action="/TiendaOnline/go">
                            <input name="to" value="mailsale" type="hidden">
                            <p class="line center pad20"><button>Enviar</button>
                        </form>
                    </div>
                 </div>
                <%} else { %>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Escriba su email y le enviamos la factura por correo:</b></p>
                        <br /><p></p>
                        <form method="post" action="/TiendaOnline/go">
                            <input name="to" value="mailsale" type="hidden"><pre>
                            <p class="line"><span>Email:  </span> <input name="email" value="" type="text" /></p></pre>
                            <p class="line center pad20"><button>Enviar</button>
                        </form><pre>
                        </pre><%if(info!=null && !info.equals("")){%> <p class="line centerred"><%=info%></p><br /> <%}%>
                        </div>
                 </div>
                <%} %>
            </div>
