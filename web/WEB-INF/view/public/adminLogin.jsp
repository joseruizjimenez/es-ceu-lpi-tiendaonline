<%-- 
    Document   : adminLogin
    Created on : 25-abr-2011, 21:18:49
...
<html>
	...
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Escriba sus datos para loguearse como ADMINISTRADOR</b></p>
                        <br /><p></p>
                        <form method="post" action="/TiendaOnline/go">
                            <input name="to" value="admin" type="hidden"><pre>
                        ...
                        <%--if(info!=null && !info.equals("")){%> <p class="line"><%=info%></p><br /> <%}--%>
                    </div>
                </div>
            </div>
