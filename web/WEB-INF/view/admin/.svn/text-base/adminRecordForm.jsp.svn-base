<%-- 
    Document   : adminRecordForm
    Created on : 25-abr-2011, 21:28:04
...
<html>
            ...
            <div id="center" class="column">
                <div id="content">
                    ...
                    <form method="post" action="/TiendaOnline/go">
                        ...
                        <input name="action" value="newrecord" type="hidden"><pre>
                        <p class="line"><span>Nombre del disco:             </span><input name="name" value="" type="text" /></p>
                        <p class="line"><span>Artista/Autor:               </span> <input name="artist" value="" type="text" /></p>
                        <p class="line"><span>Discografica:                </span> <input name="recordLabel" value="" type="text" /></p>
                        <p class="line"><span>Descripcion corta (140 max): </span> <input name="shortComment" value="" type="text" maxlenght="140" /></p>
 ...
 <textarea name="fullComment" cols="43" rows="6"></textarea>
                        <p class="line"><span>Categoria:                   </span> <input name="type" value="" type="text" /></p>
                        <p class="line"><span>Precio (decimales con '.'):  </span> <input name="price" value="" type="text" /></p>
                        <p class="line"><span>Unidades de stock:            </span><input name="stock" value="" type="text" size="4" maxlength="4" /></p>
                        </pre>
