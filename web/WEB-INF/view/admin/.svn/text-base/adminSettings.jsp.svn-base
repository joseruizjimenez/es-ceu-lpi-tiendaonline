<%-- 
    ...
    Created on : 25-abr-2011, 21:19:28
...
<html>
	...
	<div id="container">
            <div id="center" class="column"><br />
                ...
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Inserte un nuevo disco<a href="/TiendaOnline/go?to=admin&action=newrecord" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque un disco para editarlo o borrarlo<a href="/TiendaOnline/go?to=search" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque un usuario registrado<a href="/TiendaOnline/go?to=admin&action=searchuser" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque una factura de venta<a href="/TiendaOnline/go?to=admin&action=searchsale" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Salga de la cuenta (LOGOUT)<a href="/TiendaOnline/go?to=admin&action=logout" class="reg">AQUI</a></b></p>
                    </div>
                </div>
            </div>
