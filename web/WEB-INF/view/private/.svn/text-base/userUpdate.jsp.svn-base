<%-- 
    Document   : userUpdate
    Created on : 25-abr-2011, 21:12:38
...
<html>
	...
	<div id="container">
            <div id="center" class="column">
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Modifique sus datos para actualizar la cuenta:</b></p><br/>                  
                    <form method="post" action="/TiendaOnline/go">
                        <input name="to" value="user" type="hidden">
                        <input name="action" value="update" type="hidden"><pre>
                        <p class="line"><span>Nick:             </span><input name="nick" value="<jsp:getProperty name="user" property="nick" />" type="text"></input></p>
                        <p class="line"><span>Password:        </span> <input name="pass1" value="<jsp:getProperty name="user" property="password" />" type="password" /></p>
                        <p class="line"><span>Repita password: </span> <input name="pass2" value="<jsp:getProperty name="user" property="password" />" type="password" /></p>
                        <p class="line"><span>Nombre:          </span> <input name="firstName" value="<jsp:getProperty name="user" property="firstName" />" type="text" /></p>
                        <p class="line"><span>Apellidos:       </span> <input name="lastName" value="<jsp:getProperty name="user" property="lastName" />" type="text" /></p>
                        <p class="line"><span>Direccion:       </span> <input name="address" value="<jsp:getProperty name="user" property="address" />" type="text" /></p>
                        <p class="line"><span>Email:           </span> <input name="email" value="<jsp:getProperty name="user" property="email" />" type="text" /></p>
