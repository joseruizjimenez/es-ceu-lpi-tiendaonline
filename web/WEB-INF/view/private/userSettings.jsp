<%-- 
    ...
    Created on : 25-abr-2011, 21:10:51
...
<html>
	...
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Su cuenta...  </b> <%=user.getNick()%></p>
                        <pre>
                        <p class="line"><span><b>Nombre: </b><jsp:getProperty name="user" property="firstName" /></span></p><br />
                        <p class="line"><span><b>Apellidos: </b><jsp:getProperty name="user" property="lastName" /></span></p><br />
                        <p class="line"><span><b>Direccion: </b><jsp:getProperty name="user" property="address" /></span></p><br />
                        <p class="line"><span><b>Forma de pago: </b><jsp:getProperty name="user" property="paymentForm" /></span></p><br />
                        <p class="line"><span><b>Email: </b><jsp:getProperty name="user" property="email" /></span></p><br />
                        <p class="line"><span><b>Fecha de Nacimiento: </b><jsp:getProperty name="user" property="birthDateAsString" /></span></p>
                        </pre>
                    </div>
                ...
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Actualice sus datos<a href="/TiendaOnline/go?to=user&action=update" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Borre su cuenta<a href="/TiendaOnline/go?to=user&action=delete" class="reg" onclick="return confirm('¿Está seguro?');">AQUI</a></b></p>
                    </div>
                </div>
            </div>
